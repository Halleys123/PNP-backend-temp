...
const attachAdminViaRefresh = (0, utils_1.async_error_handler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    const user = yield adminPerma_1.AdminModelPerma.findById(decodedToken._id);
    if (!user)
        throw new utils_1.Custom_error({
