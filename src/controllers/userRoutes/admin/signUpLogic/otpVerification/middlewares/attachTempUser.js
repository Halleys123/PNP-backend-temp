...
exports.attachTempAdmin = void 0;
const utils_1 = require("@himanshu_guptaorg/utils");
const adminTemp_1 = require("../../../../../../models/admin/schema/adminTemp");
const attachTempAdmin = (0, utils_1.async_error_handler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const foundUser = yield adminTemp_1.AdminModelTemp.findById(tokenInfo._id);
    if (!foundUser)
        throw new utils_1.Custom_error({
...
exports.attachTempAdmin = attachTempAdmin;
