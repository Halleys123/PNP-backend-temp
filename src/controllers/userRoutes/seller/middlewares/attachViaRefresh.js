...
const attachSellerViaRefresh = (0, utils_1.async_error_handler)(async (req, res, next) => {
    ...
    const user = await sellerPerma_1.SellerModelPerma.findById(decodedToken._id);
    if (!user)
        throw new utils_1.Custom_error({
